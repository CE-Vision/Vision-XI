...
function Member({ name, image }) {
    return (
        <Center flexDirection="column" py={6} onClick={() => window.open("google.com", "_blank")}>
            <Image borderRadius="50%" boxSize="200px" objectFit="cover" src={image} alt={name} />
...
export default function Team() {
    return (
        <Container maxW={"6xl"} py="12">
            ...
            <Text pt="10" fontWeight="semi-bold" fontSize="30" textAlign="center" textDecoration="underline">
                Cheif Co-ordinators
            </Text>
